...
from .views import (
    ...
    JobAlertManualRunView,
    JobAlertMatchFeedbackView,
    JobAlertMatchListView,
    # Phase 12 — Notifications
    NotificationListView,
    NotificationMarkReadView,
    NotificationUnreadCountView,
    ResumeBulkDeleteView,
    ResumeDeleteView,
    ResumeListView,
    ResumeUpdateView,
...
from .views_celery import (
    CeleryActiveTasksView,
    CeleryQueueLengthView,
    CeleryTaskStatusView,
    CeleryWorkersView,
)
from .views_chat import (
    ResumeChatDetailView,
    ResumeChatFinalizeView,
    ResumeChatListView,
    ResumeChatResumesView,
    ResumeChatStartView,
    ResumeChatSubmitView,
