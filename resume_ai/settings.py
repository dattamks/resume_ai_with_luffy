...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        ...
        'user': config('USER_THROTTLE_RATE', default='500/hour'),
        'analyze': config('ANALYZE_THROTTLE_RATE', default='20/hour'),
        'readonly': config('READONLY_THROTTLE_RATE', default='1000/hour'),
        'write': config('WRITE_THROTTLE_RATE', default='150/hour'),
        'payment': config('PAYMENT_THROTTLE_RATE', default='60/hour'),
